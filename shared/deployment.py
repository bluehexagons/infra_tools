...
class DeploymentOrchestrator:
    """Handles deployment of repositories to the server."""
    ...
    def __init__(self, base_dir: str = "/var/www", web_user: str = "www-data", web_group: str = "www-data"):
        ...
        Args:
            base_dir: Base directory for deployments (default: /var/www)
    ...
    def get_deployment_path(self, domain: Optional[str], path: str, git_url: str) -> str:
        """
        Calculate the deployment path for a repository.
        ...
        Returns:
            Full path where the repository should be deployed
        """
        ...
        # Use dir_name if available, otherwise use repo_name
        if dir_name:
    ...
    def deploy_from_archive(self, source_path: str, domain: Optional[str], path: str, 
        ...
        Args:
            ...
            path: URL path
            git_url: Git repository URL
            run_func: Function to run commands (e.g., utils.run)
        ...
        # Move repository to destination
        ...
        # Return deployment info for nginx configuration
        return {
            'dest_path': dest_path,
            'domain': domain,
            'path': path,
