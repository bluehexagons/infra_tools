...
- [`AGENTIC_VMS.md`](./AGENTIC_VMS.md) for headless, full-capability,
  approval-panel, unrestricted, and hardened coding-VM examples
- [`PRIVILEGE_APPROVALS.md`](./PRIVILEGE_APPROVALS.md) for the separate HTTPS
  approval page and administrator allowlists
...
but cannot approve requests. The initial broker supports VM reboot and exact
administrator-registered service restarts. See [Privilege approvals](PRIVILEGE_APPROVALS.md)
and the complete [Agentic VM examples](AGENTIC_VMS.md).
