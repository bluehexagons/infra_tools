...
| --- | --- | --- | --- | --- |
| Transactional execution and state | Active; durable marker primitive landed | P0 | [#97](https://github.com/bluehexagons/infra_tools/issues/97) | [Transactional execution](TRANSACTIONAL_EXECUTION.md): integrate the versioned operation record into setup/deployment recovery and finish the command-caller inventory. |
