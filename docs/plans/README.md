...
| --- | --- | --- | --- | --- |
| Transactional execution and state | Active; ready for the next slice | P0 | [#97](https://github.com/bluehexagons/infra_tools/issues/97) | [Transactional execution](TRANSACTIONAL_EXECUTION.md): finish the command-caller inventory, define the durable operation-record schema, and add setup/deployment interruption markers. |
